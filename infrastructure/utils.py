...
def sample_trajectory(
    env: gym.Env, policy: BasePolicy, max_length: int, render: bool = False
) -> Dict[str, np.ndarray]:
...
def sample_n_trajectories(
    env: gym.Env, policy: BasePolicy, ntraj: int, max_length: int, render: bool = False
):
